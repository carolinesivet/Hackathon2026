...
const C1_METRICS = [
  {
    ...
    columns: [
      ...
      col('year_of_introduction', 'Year of Introduction',  'text', { required: true }),
    ],
    docRequired: false,
  },
  {
    ...
    columns: [
      col('year',         'Year',                                            'text', { required: true }),
  ...
  },
  {
    ...
    columns: [
      ...
      col('year_introduction', 'Year of Introduction',                        'text',   { required: true }),
      col('cbcs_status',       'Status of CBCS Implementation (Yes/No)',      'select', { options: ['Yes', 'No'], required: true }),
      col('cbcs_year',         'Year of Implementation of CBCS',              'text',   { required: false }),
  ...
  },
  {
    ...
    columns: [
      ...
      col('year_of_offering',    'Year of Offering',                               'text',   { required: true }),
  ...
  },
  {
    ...
    columns: [
      ...
      col('course_code',   'Course Code',           'text', { required: true }),
      col('year_offering', 'Year of Offering',      'text', { required: true }),
...
const C2_METRICS = [
  {
    ...
    columns: [
      col('year_of_enrollment', 'Year of Enrollment',          'text', { required: true }),
      col('student_name',       'Name of Student',             'text', { required: true }),
  ...
  },
  {
    ...
    columns: [
      col('year_of_passing',   'Year of Passing Final Year Exam',  'text', { required: true }),
      col('student_name',      'Name of Student',                  'text', { required: true }),
  ...
  },
  {
    ...
    columns: [
      ...
      col('designation',           'Designation',                                    'text',   { required: true }),
      col('year_of_appointment',   'Year of Appointment',                            'text',   { required: true }),
      col('nature_of_appointment', 'Nature of Appointment',                          'text',   { required: true }),
      ...
      col('still_serving',         'Still Serving? / Last Year of Service',          'text',   { required: true }),
    ],
    docRequired: false,
  },
  {
...
const C3_METRICS = [
  ...
  },
  {
    ...
    columns: [
      ...
      col('qualification',      'Qualification and Year of Obtaining',           'text',   { required: true }),
      col('qualification_year', 'Year of Qualification',                         'text',   { required: true }),
      col('is_research_guide',  'Recognised as Research Guide?',                 'select', { options: ['Yes', 'No'], required: true }),
      col('recognition_year',   'Year of Recognition as Research Guide',         'text',   { required: false }),
      col('still_serving',      'Still Serving? / Last Year of Service',         'text',   { required: true }),
      col('scholar_name',       'Name of the Scholar',                           'text',   { required: false }),
      col('scholar_reg_year',   'Year of Registration of the Scholar',           'text',   { required: false }),
  ...
  },
  {
    ...
    columns: [
      ...
      col('year_of_award',     'Year of Award',                           'text',   { required: true }),
  ...
  },
  {
    ...
    columns: [
      ...
      col('date_from_to',  'Date From – To',                         'text',   { required: true }),
  ...
  },
  {
    ...
    columns: [
      ...
      col('year',         'Year of Publication',                              'text',    { required: true }),
  ...
  },
  {
    ...
    columns: [
      ...
      col('year_of_publication',    'Year of Publication',                        'text',    { required: true }),
      col('isbn_issn',              'ISBN / ISSN Number of the Proceeding',       'text',    { required: true }),
  ...
  },
  {
    ...
    columns: [
      ...
      col('year',                  'Year of the Activity',                          'text',   { required: true }),
  ...
  },
  {
    ...
    columns: [
      ...
      col('year',                'Year of Collaboration',                          'text',    { required: true }),
  ...
  },
  {
    ...
    columns: [
      ...
      col('year_of_signing',      'Year of Signing MoU',                              'text',    { required: true }),
      col('duration',             'Duration',                                          'text',    { required: true }),
...
const C4_METRICS = [
  {
    ...
    columns: [
      ...
      col('ict_type',   'Type of ICT Facility',                                'text', { required: true }),
...
const C5_METRICS = [
  ...
  },
  {
    ...
    columns: [
      ...
      col('date_implemented',  'Date of Implementation (DD-MM-YYYY)',            'date',    { required: true }),
  ...
  },
  {
    ...
    columns: [
      col('year',              'Year',                                    'text', { required: true }),
      col('student_name',      'Name of Student Placed & Contact',        'text', { required: true }),
      col('program_graduated', 'Program Graduated From',                  'text', { required: true }),
      col('employer_name',     'Name of Employer & Contact',              'text', { required: true }),
  ...
  },
  {
    ...
    columns: [
      col('event_date',   'Date of Event / Activity (DD-MM-YYYY)',  'date', { required: true }),
...
const C6_METRICS = [
  {
    ...
    columns: [
      ...
      col('year_implemented','Year of Implementation',               'text',     { required: true }),
    ],
    docRequired: false,
  },
  {
  ...
  },
  {
    ...
    columns: [
      col('dates',                     'Dates (From – To) (DD-MM-YYYY)',                           'text',   { required: true }),
  ...
  },
  {
    ...
    columns: [
      ...
      col('duration',      'Duration (From – To) (DD-MM-YYYY)',   'text', { required: true }),
    ],
    docRequired: false,
  },
  {
    ...
    columns: [
      col('year',        'Year',                                                        'text',    { required: true }),
      col('agency_name', 'Name of Non-Government Funding Agency / Individual',          'text',    { required: true }),
